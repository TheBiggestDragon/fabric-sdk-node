...
function addListener(listener, listenerSessions, sessionSupplier) {
    return __awaiter(this, void 0, void 0, function () {
        var session;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!!listenerSessions.has(listener)) return [3 /*break*/, 3];
                    return [4 /*yield*/, sessionSupplier()];
                case 1:
                    session = _a.sent();
                ...
                case 2:
                    _a.sent();
                    _a.label = 3;
                case 3: return [2 /*return*/, listener];
            }
        });
    });
}
...
function removeListener(listener, listenerSessions) {
    var session = listenerSessions.get(listener);
    if (session) {
        session.close();
