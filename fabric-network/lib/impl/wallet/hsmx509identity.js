 ...
 */
var HsmX509Provider = /** @class */ (function () {
    /**
     ...
     */
    function HsmX509Provider(options) {
        if (options === void 0) { options = {}; }
        this.type = 'HSM-X.509';
        // options.software must be set to false to enable HSM
        var cryptoOptions = Object.assign({}, options, { software: false });
        this.cryptoSuite = fabric_common_1.User.newCryptoSuite(cryptoOptions);
    }
    HsmX509Provider.prototype.getCryptoSuite = function () {
        return this.cryptoSuite;
    };
    HsmX509Provider.prototype.fromJson = function (data) {
    ...
    HsmX509Provider.prototype.toJson = function (identity) {
        var data = {
            credentials: {
    ...
    HsmX509Provider.prototype.getUserContext = function (identity, name) {
        return __awaiter(this, void 0, void 0, function () {
            var user, publicKey, privateKey;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.cryptoSuite.importKey(identity.credentials.certificate)];
                    case 1:
                        publicKey = _a.sent();
                        return [4 /*yield*/, this.cryptoSuite.getKey(publicKey.getSKI())];
                    case 2:
                        privateKey = _a.sent();
                        return [4 /*yield*/, user.setEnrollment(privateKey, identity.credentials.certificate, identity.mspId)];
                    case 3:
                        _a.sent();
