...
var couchdbwalletstore_1 = require("./couchdbwalletstore");
var filesystemwalletstore_1 = require("./filesystemwalletstore");
var inmemorywalletstore_1 = require("./inmemorywalletstore");
...
var Wallets = /** @class */ (function () {
     ...
     */
    Wallets.newInMemoryWallet = function () {
        var store = new inmemorywalletstore_1.InMemoryWalletStore();
     ...
     * @returns {Promise<module:fabric-network.Wallet>} A wallet.
     */
    Wallets.newFileSystemWallet = function (directory) {
        return __awaiter(this, void 0, void 0, function () {
            var store;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, filesystemwalletstore_1.FileSystemWalletStore.newInstance(directory)];
                    case 1:
                        store = _a.sent();
                        return [2 /*return*/, new wallet_1.Wallet(store)];
                }
            });
        });
    };
     ...
     * @returns {Promise<module:fabric-network.Wallet>} A wallet.
     */
    Wallets.newCouchDBWallet = function (config, dbName) {
        if (dbName === void 0) { dbName = 'wallet'; }
        return __awaiter(this, void 0, void 0, function () {
            var store;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, couchdbwalletstore_1.CouchDBWalletStore.newInstance(config, dbName)];
                    case 1:
                        store = _a.sent();
                        return [2 /*return*/, new wallet_1.Wallet(store)];
                }
