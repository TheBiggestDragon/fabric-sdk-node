...
var fabricerror_1 = require("../../errors/fabricerror");
var util = require("util");
var Logger = require("../../logger");
var logger = Logger.getLogger('RoundRobinQueryHandler');
var RoundRobinQueryHandler = /** @class */ (function () {
    function RoundRobinQueryHandler(peers) {
        this.currentPeerIndex = 0;
        logger.debug('constructor: peers=%j', peers.map(function (peer) { return peer.name; }));
        this.peers = peers;
    }
    RoundRobinQueryHandler.prototype.evaluate = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            var method, startPeerIndex, errorMessages, i, peerIndex, peer, results, result, responseError, message, error;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        method = 'evaluate';
                        logger.debug('%s - start', method);
                        startPeerIndex = this.currentPeerIndex;
                    ...
                    case 1:
                        ...
                        peerIndex = (startPeerIndex + i) % this.peers.length;
                    ...
                    case 2:
                        ...
                        if (result instanceof Error) {
                            ...
                            if (result.isEndorsed) {
                                ...
                                responseError = Object.assign(new Error(result.message), result);
                                throw responseError;
                            }
                        }
                        _a.label = 3;
                    ...
                    case 4:
                        ...
                        error = new fabricerror_1.FabricError(message);
