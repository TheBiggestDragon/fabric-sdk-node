...
var logger = Logger.getLogger('SingleQueryHandler');
var SingleQueryHandler = /** @class */ (function () {
    function SingleQueryHandler(peers) {
        this.currentPeerIndex = 0;
        logger.debug('constructor: peers=%j', peers.map(function (peer) { return peer.name; }));
        this.peers = peers;
    }
    SingleQueryHandler.prototype.evaluate = function (query) {
                    ...
                    case 2:
                        ...
                        if (result instanceof Error) {
                            ...
                            if (result.isEndorsed) {
                                ...
                                responseError = Object.assign(new Error('peer error response: ' + result.message), result);
                                throw responseError;
                            }
                        }
                        _a.label = 3;
