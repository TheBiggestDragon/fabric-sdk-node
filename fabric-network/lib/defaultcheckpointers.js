...
var filecheckpointer_1 = require("./impl/filecheckpointer");
/**
 ...
 */
var DefaultCheckpointers = /** @class */ (function () {
    function DefaultCheckpointers() {
    }
    /**
     ...
     */
    DefaultCheckpointers.file = function (path) {
        return __awaiter(this, void 0, void 0, function () {
            var checkpointer;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        checkpointer = new filecheckpointer_1.FileCheckpointer(path);
                        return [4 /*yield*/, checkpointer.init()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, checkpointer];
                }
            });
        });
    };
    return DefaultCheckpointers;
}());
